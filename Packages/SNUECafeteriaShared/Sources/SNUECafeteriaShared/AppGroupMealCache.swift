...
public nonisolated enum AppGroupMealCache {
    ...
    public static func load() -> [CachedDayMeal] {
    ...
    @discardableResult
    public static func save(_ meals: [CachedDayMeal]) -> Bool {
        guard !meals.isEmpty,
    ...
    public static func shouldRefreshToday() -> Bool {
        let meals = load()
    ...
    public static func nearestMeal(from now: Date = .now) -> (meal: CachedDayMeal, type: MealType)? {
        let meals = load()
    ...
    public static func resolveNearestMeal(from now: Date = .now) throws(MealIntentError) -> (meal: CachedDayMeal, type: MealType) {
...
public nonisolated enum MealIntentError: LocalizedError {
    case noMealFound
