...
public struct FetchMealForDateListIntent: AppIntent {
    public init() {}

    public static let title: LocalizedStringResource = "특정 날짜 식단 목록 조회"
    public static let description = IntentDescription("특정 날짜의 중식 또는 석식 메뉴 항목을 배열로 가져옵니다.")
    ...
    public var mealType: MealTypeAppEnum
