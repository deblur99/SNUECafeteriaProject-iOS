...
public struct FetchNearestMealListIntent: AppIntent {
    public init() {}

    public static let title: LocalizedStringResource = "가장 가까운 식단 목록 조회"
    public static let description = IntentDescription("현재 시각 기준으로 오늘 중식 또는 석식 메뉴 항목을 배열로 가져옵니다.")
