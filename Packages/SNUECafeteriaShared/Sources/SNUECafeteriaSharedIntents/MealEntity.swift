...
public nonisolated struct MealEntity: AppEntity {
    public static let defaultQuery = MealEntityQuery()
    public static let typeDisplayRepresentation: TypeDisplayRepresentation = "식단"

    /// `DateFormatter.kstDash` 형식의 날짜 문자열 (예: "2026-05-29")
    public let id: String
    public let date: Date
    public let lunchItems: [String]
    public let dinnerItems: [String]
    ...
    public init(from cached: CachedDayMeal) {
